...
public class LargeAppliance extends Product implements DeliveryChargeCalculator{
	private LargeAppliance(){
		super("", BigDecimal.ZERO, 0.0);
	}

	public LargeAppliance(String name, String price, double weight){
	...
	public LargeAppliance(String price, double weight){
		super("대형가전",new BigDecimal(price), weight);
	}
